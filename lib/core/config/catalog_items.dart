...
List<CatalogItem> commonCatalogItems = <CatalogItem>[
  ...
  CatalogItem(
    title: (BuildContext context) => context.l10n.hero_animation_title,
    detail: (BuildContext context) => context.l10n.hero_animation_detail,
    route: const HeroAnimationRoute(),
  ),
  CatalogItem(
    title: (BuildContext context) => context.l10n.animated_container_title,
  ...
  CatalogItem(
    title: (BuildContext context) => context.l10n.animated_switcher_title,
  ...
  CatalogItem(
    title: (BuildContext context) => context.l10n.hive_title,
